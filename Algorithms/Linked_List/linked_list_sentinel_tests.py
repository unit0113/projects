import unittest
import linked_list_sentinel as ll
...
class TestLinkedList(unittest.TestCase):
    ...
    def test_linked_list_creation_empty(self):
        a = ll.Linked_List()
        self.assertEqual(None, a.sentinel.next)
        self.assertEqual(None, a.sentinel.prev)
        self.assertEqual(0, a.length)

    def test_linked_list_creation_single(self):
        a = ll.Linked_List(5)
        self.assertEqual(5, a.sentinel.next.value)
        self.assertEqual(5, a.sentinel.prev.value)
        self.assertEqual(1, a.length)
        self.assertEqual(None, a.sentinel.next.next)
        self.assertEqual(a.sentinel, a.sentinel.next.prev)
    
    def test_linked_list_creation_multiple(self):
        a = ll.Linked_List(1, 2, 3, 4, 5)
        self.assertEqual(5, a.sentinel.next.value)
        self.assertEqual(1, a.sentinel.prev.value)
        self.assertEqual(5, a.length)
        self.assertEqual(4, a.sentinel.next.next.value)
        self.assertEqual(None, a.sentinel.next.prev.value)
        self.assertEqual(2, a.sentinel.prev.prev.value)
    
    def test_add_front_single(self):
        a = ll.Linked_List(5)
        a.add_front(10)
        self.assertEqual(10, a.sentinel.next.value)
        self.assertEqual(5, a.sentinel.prev.value)
        self.assertEqual(2, a.length)
        self.assertEqual(5, a.sentinel.next.next.value)
        self.assertEqual(None, a.sentinel.next.prev.value)
        self.assertEqual(10, a.sentinel.prev.prev.value)
    ...
    def test_add_front_multiple(self):
        ...
        self.assertEqual(30, a.sentinel.next.value)
        self.assertEqual(5, a.sentinel.prev.value)
        self.assertEqual(4, a.length)
        self.assertEqual(20, a.sentinel.next.next.value)
        self.assertEqual(None, a.sentinel.next.prev.value)
        self.assertEqual(10, a.sentinel.prev.prev.value)    
    ...
    def test_add_rear_multiple(self):
        ...
        a.add_rear(5, 4, 3)
        self.assertEqual(10, a.sentinel.next.value)
        self.assertEqual(3, a.sentinel.prev.value)
        self.assertEqual(4, a.length)
        self.assertEqual(5, a.sentinel.next.next.value)
        self.assertEqual(None, a.sentinel.next.prev.value)
        self.assertEqual(4, a.sentinel.prev.prev.value)
    ...
    def test_remove_front(self):
        ...
        self.assertEqual(5, a.remove_first())
        self.assertEqual(4, a.sentinel.next.value)
        self.assertEqual(None, a.sentinel.next.prev.value)
        self.assertEqual(4, a.length)
    ...
    def test_remove_last(self):
        ...
        self.assertEqual(5, a.sentinel.next.value)
        self.assertEqual(None, a.sentinel.prev.next.value)
        self.assertEqual(4, a.length)
    ...
    def test_remove(self):
        a = ll.Linked_List(1, 2, 3, 4, 5)
        a.remove(1)
        self.assertEqual(2, a.sentinel.prev.value)
        a.remove(5)
        self.assertEqual(4, a.sentinel.next.value)
        a.remove(3)
        self.assertEqual(2, a.sentinel.next.next.value)
        self.assertEqual(4, a.sentinel.prev.prev.value)
