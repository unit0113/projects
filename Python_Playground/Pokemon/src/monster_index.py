...
class MonsterIndex:
    ...
    def display_list(self):
        ...
        # Lines
        for i in range(1, min(len(self.monsters), self.visible_items)):
    ...
    def display_main(self, dt):
        ...
        energy_rect = hp_text.get_frect(midleft=energybar_rect.midleft + vector(10,0))
        ...
        for index, (stat, value) in enumerate(monster_stats.items()):
            ...
            # Icon
            icon_surf = self.ui_frames[stat.lower()]
            ...
            draw_bar(surface=self.display_surface,
                 rect=bar_rect,
                 value=value,
                 max_value=self.max_stats[stat.lower()] * monster.level,
                 color=COLORS['white'],
                 bg_color=COLORS['black']
                 )
