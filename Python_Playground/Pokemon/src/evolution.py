    ...
    def update(self, dt):
        ...
        if not self.timers["start"].active:
            ...
            if self.tint_amount < 255:
                ...
                self.start_monster_surf_white.set_alpha(self.tint_amount)
                self.display_surface.blit(self.start_monster_surf_white)
                ...
                self.display_surface.blit(self.start_monster_surf, text_rect)
            else:
                ...
                self.display_surface.blit(self.end_monster_surf, text_rect)
