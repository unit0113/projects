...
class Main:
    ...
    def imports(self):
        ...
        # palm trees
        self.palms = {
            folder: import_folder(f"graphics/terrain/palm/{folder}")
        ...
        self.tooth = {
            folder: import_folder(f"graphics/enemies/tooth/{folder}")
            for folder in list(walk("graphics/enemies/tooth"))[0][1]
        }
        self.shell = {
            folder: import_folder(f"graphics/enemies/shell_left/{folder}")
        ...
        self.player_graphics = {
            folder: import_folder(f"graphics/player/{folder}")
