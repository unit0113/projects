...
class EvilSpaceShip(Ship):
    def __init__(self, level):
        ...
        self.point_value = self.health * POINT_HEALTH_MULTIPLIER + self.speed * POINT_SPEED_MULTIPLIER + self.laser_type_current_index * POINT_LASER_MULTIPLIER
        self.laser_timer = AI_BASE_FIRE_RATE * FPS / 60
        self.base_damage = AI_BASE_DMG * (1 + (self.level - 1) / 10)
